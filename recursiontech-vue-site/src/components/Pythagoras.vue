<template>
  <div class="canvas_wrapper">
    <canvas id="pythagoras_canvas" width="800" height="500" @mousemove="handleMouseMove"
...
export default defineComponent({
  ...
  setup() {
     ...
     * @param position 
     */
    const updateOrder: any = (pos_x: number, pos_y: number) => {
     ...
     * @param pos_y 
     */
    const updateHorizontalPos: any = (pos_x: number, pos_y: number) => {
    ...
    const update: any = (pos_x: number, pos_y: number) => {
      ...
      updateOrder(pos_x, pos_y);
      updateHorizontalPos(pos_x, pos_y);
      calcVariables();
      draw();
    }
